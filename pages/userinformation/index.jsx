    ...
    <>
      ...
      <main className="backgroudiamge--profile h-[100vh]">
        ...
        <div className="w-[100%]">
          ...
          <div className="absolute centered xl:w-[80%] md:z-20 md:bottom-0 md:w-[100%] md:px-0 w-[45%]  top-0">
            <div className="pl-24 md:w-[100%] md:px-9 md:absolute md:bottom-[20px] md:flex md:flex-col ">
              <div className="flex md:hidden   items-center gap-4">
                <img src="Images/MaskGroup57 1.svg" />
                <h4 className="Title--text">ontheMoons</h4>
              </div>
              <h4 className="Subtitle--text md:flex md:h-[45px] md:items-center md:justify-start md:text-start  md:text-[31px] md:w-[100%] md:leading-3 w-[80%] md:pt-3 pt-1">
                Profile Creation{" "}
              </h4>
              <form onSubmit={handleSubmit}>
                <div className="overflow-y-scroll scroll-bar md:h-[486px] relative md:w-[100%] max-h-[589px] height--responsive w-[80%]">
                  <div className="bg-white mt-3 md:mt-4 flex items-center w-[96%] rounded-[20px] h-[74px] md:h-[60px] md:rounded-[10px] md:w-[100%] border-2 border-white">
                    <input
                      placeholder="Name"
                      id="name"
                      name="name"
                      ...
                      className="w-[100%] md:w-[100%] md:text-[20px] md:h-[60px] md:rounded-[10px] pl-4 createusername--text outline-none rounded-[20px] h-[64px]"
                      type="text"
                  ...
                  >
                    <span
                      className="w-[100%] md:w-[100%] md:text-[17px] md:h-[60px] md:rounded-[10px] pl-4 createusername--text  outline-none rounded-[20px] h-[64px]"
                      title={
                  ...
                  <div className=" Radius--rounded bg-[#FF0034]  pt-0 pb-[33px] flex w-[100%] sticky items-center justify-between gap-[130px] md:gap-[80px] md:w-[100%] md:bottom-[-6px] -bottom-1">
                    <button className="bg-white mt-4 md:mt-4 justify-center flex items-center w-[150px] rounded-[20px] h-[74px] md:h-[60px] md:rounded-[10px] md:w-[100%] border-2 border-white md:text-[18px] profleback-text">
                      Back
                    </button>
                    <button className="bg-white mt-8 md:mt-4 justify-center flex items-center w-[150px] rounded-[20px] profleback-text h-[74px] md:h-[60px] md:rounded-[10px] md:w-[100%] border-2 md:text-[18px] border-white">
                      Step 2
                    </button>
                  </div>
                </div>
