    ...
    <>
      ...
      <main className="backgroudiamge">
        ...
        <div className="w-[100%]">
          ...
          <form onSubmit={otp}>
            <div className="absolute xl:w-[60%] md:z-20 md:bottom-0 md:w-[100%] md:px-0 w-[40%] pl-24 centered top-0">
              <div className="loginscreen--height md:w-[100%] md:px-6 md:absolute md:bottom-[20px] md:flex md:flex-col md:items-center md:justify-center">
                ...
                <div className="flex loginscreen--text items-center justify-between md:w-[100%] pt-4 md:pt-4 w-[77%] md:gap-3">
                  <input
                    className="max-w-[64px] phonenumber--text  outline-none text-center rounded-[20px] h-[64px]"
                    type="text"
                    maxLength={1}
                ...
                <div className="flex items-center justify-between md:w-[100%] w-[77%] pt-4">
                ...
                <Link href="/avatar" className="md:w-[100%]">
                  <button className="bg-white justify-center md:h-[60px] mt-4 flex items-center md:w-[100%] w-[77%] cursor-pointer rounded-[20px] h-[64px] md:rounded-[10px] md:mt-3 border-2 gap-2 border-white">
